...
MONGO_URI = os.environ.get("MONGO_URI", "mongodb+srv://rashmithakeshireddy:Renuka232006@mongodb.sn6rje7.mongodb.net/userdb?retryWrites=true&w=majority&tls=true")
